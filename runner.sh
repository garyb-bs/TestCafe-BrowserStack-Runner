...
run_parallel_1t_Nb(){
    ...
    browser_list=""
    browser_list="${browser_list}@browserStack/browserstack:firefox@75.0:Windows 8.1" 
    browser_list="${browser_list}@browserStack/browserstack:chrome@80.0:OS X High Sierra" 
    browser_list="${browser_list}@browserStack/browserstack:firefox@75.0:Windows 8.1" 
    browser_list="${browser_list}@browserStack/browserstack:Samsung Galaxy S20@10.0" 
    browser_list="${browser_list}@browserStack/browserstack:iPhone XS@13.0"
